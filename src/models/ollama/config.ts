...
export const DEFAULT_OLLAMA_GENERATION_OPTIONS: OllamaGenerationOptions = {
  ...
  topP: 0.9, //0.95
  topK: 40, //64
  numCtx: 8192, // context: low: 4096, medium: 8,192, high: 16,384, xhigh: 32,768, extreme: 65,536, insane: 131,072
  numPredict: 2048,
  repeatPenalty: 1.1,
};

export const DEFAULT_OLLAMA_THINKING_MODE: OllamaThinkingMode = "default";

export const DEFAULT_OLLAMA_CONFIG: OllamaConfig = {
  host: DEFAULT_OLLAMA_HOST,
  selectedModel: "gemma4:e4b",
  generationOptions: DEFAULT_OLLAMA_GENERATION_OPTIONS,
  thinkingMode: DEFAULT_OLLAMA_THINKING_MODE,
};
